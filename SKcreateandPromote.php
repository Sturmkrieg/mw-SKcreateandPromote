 ...
 *             http://www.sturmkrieg.de/Benutzer:Inquisitor_Ehrenstein
 *
...
class CreateAndPromote extends Maintenance {
	...
	public function __construct() {
		...
		$this->addOption( "bureaucrat", "Grant the account bureaucrat rights" );
                $this->addOption( "oversight", "Grant the account oversight rights" );
                $this->addOption( "sysadmin". "Grant the account sysadmin rights" );
	...
	public function execute() {
		...
		if ( $this->hasOption( 'bureaucrat' ) ) {
			$user->addGroup( 'bureaucrat' );
                ...
                if ( $this->hasOption( 'oversight' ) ) {
                        $user->addGroup( 'oversight' );
                }
                if ( $this->hasOption( 'sysadmin' ) ) {
                        $user->addGroup( 'sysadmin' );
                }
